...
public class UserRepositoryTest extends AbstractTestNGSpringContextTests {
    ...
    public static Object[][] user_contains_false() {
        return new Object[][] {
                {"nasybullin2000@gmail.com"},  {"ilnur@yandex.ru"}, {"2000@gmail.com"}
        };
    }
    ...
    public static Object[][] user_insert_true() {
        return new Object[][] {
                {"Aynur", "aynur.nasybullin@yandex.ru", "111222333"},
    ...
    public static Object[][] user_insert_sql_exception() {
        return new Object[][] {
                {"Ilnyr", "ilnur.nasybullin2000@yandex.ru", "12345678"},
                {"Ilnyr", "IANasybullin@stud.kpfu.ru", "12345678"}
        };
    }
